...
public interface CListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code structORunionwithdec}
	 * labeled alternative in {@link CParser#structOrUnionSpecifier}.
	 * @param ctx the parse tree
	 */
	void enterStructORunionwithdec(CParser.StructORunionwithdecContext ctx);
	/**
	 * Exit a parse tree produced by the {@code structORunionwithdec}
	 * labeled alternative in {@link CParser#structOrUnionSpecifier}.
	 * @param ctx the parse tree
	 */
	void exitStructORunionwithdec(CParser.StructORunionwithdecContext ctx);
	/**
	 * Enter a parse tree produced by the {@code structORunion}
	 * labeled alternative in {@link CParser#structOrUnionSpecifier}.
	 * @param ctx the parse tree
	 */
	void enterStructORunion(CParser.StructORunionContext ctx);
	/**
	 * Exit a parse tree produced by the {@code structORunion}
	 * labeled alternative in {@link CParser#structOrUnionSpecifier}.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by the {@code globalORlocal}
	 * labeled alternative in {@link CParser#typedefName}.
	 * @param ctx the parse tree
	 */
	void enterGlobalORlocal(CParser.GlobalORlocalContext ctx);
	/**
	 * Exit a parse tree produced by the {@code globalORlocal}
	 * labeled alternative in {@link CParser#typedefName}.
	 * @param ctx the parse tree
	 */
	void exitGlobalORlocal(CParser.GlobalORlocalContext ctx);
	/**
